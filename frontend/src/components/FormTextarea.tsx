...
const textareaBase =
  'py-2.5 px-3.5 bg-input border border-border rounded text-zinc-100 min-h-[100px] resize-y placeholder:text-muted/70 transition-colors hover:border-zinc-600 focus:outline-none focus:border-border-focus focus:ring-[3px] focus:ring-indigo-500/20'
